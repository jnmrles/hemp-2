        ...
        <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="mx-auto mb-12 text-center lg:mb-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
              stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-[#22d3ee]  dark:text-primary-400">
            ...
            <h6 class="font-medium text-white">Unites States</h6>
          </div>
          <div class="mx-auto mb-12 text-center lg:mb-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
              stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-[#22d3ee]  dark:text-primary-400">
            ...
            <h6 class="font-medium text-white">New York, 94126</h6>
          </div>
          <div class="mx-auto mb-6 text-center md:mb-0">
            ...
            <h6 class="font-medium text-white">+ 01 234 567 89</h6>
          </div>
          <div class="mx-auto text-center">
            ...
            <h6 class="font-medium text-white">Tax ID: 273 384</h6>
          </div>
        </div>
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              <span className="block mb-2 text-lg font-semibold text-gray-300">
                Our Services
              </span>
  ...
  return (
    <>
      <div className="w-full  px-4 md:w-1/2 lg:w-1/3">
        <motion.div 
       className="mb-8  w-full bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 hover:border hover:border-[#22d3ee] rounded-[20px] bg-black p-10 shadow-md hover:shadow-2xl hover:shadow-[#22d3ee] md:px-7 xl:px-10">
          <div
            className={`mb-8 flex h-[70px] w-[70px] p-3 items-center justify-center rounded-2xl bg-black/25`}
          >
            {icon}
          </div>
             ...
             >
                ...
                >
                  ...
                  <Image
                    ...
                    aspectRatio="1/1"
                    sizes="(min-width: 35em) 20vw, 50vw"
                  />
                 
                  <small className='text-[#c5c6c7m  ] font-small '>
